...
class fav_list extends StatefulWidget{
  @override
  _fav_list_state createState() => _fav_list_state();
}
          ...
          if(uid == doc.data['owner']) {
            if (doc.data['favourite']) {
              setState(() {
                ...
                /////////////////////////////////////////////////////////////////////////////8project.isFavourite = doc.data['favourite'];
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(MediaQuery.of(context).size.width/3.4, MediaQuery.of(context).size.height/10),
            child: SizedBox(
                      ...
                      child: Stack(
                        children: [
                          Row(
                            children: [
                              Transform.translate(
                                  offset: Offset(MediaQuery.of(context).size.width/10, MediaQuery.of(context).size.height/35),
                                  child: IconButton(
                                    onPressed: () async {
                              ...
                              Transform.translate(
                                offset: Offset(MediaQuery.of(context).size.width/5 , MediaQuery.of(context).size.height/35),
                                child: IconButton(
                              ...
                              Transform.translate(
                                offset: Offset(MediaQuery.of(context).size.width/3 , MediaQuery.of(context).size.height/30),
                                child: Text(
