...
import 'package:flutter_app/ProjectRevenue.dart';
        ...
        if(district == row[0]){
          ...
          //**************** We have three different ranges of age groups (15-20 , 20-25 , 25-40 )****************
            ...
            if(row[1] > row[2] && row[1] > row [3]){
              ages = ['الاعمار من 15 الى 20', 'الاعمار من 20 الى 25', 'الاعمار من 25 الى 40'];
              salesData = [
          ...
          content: Container(
            ...
            child: Column(
              children: <Widget>[
                ...
                Text('تم حفظ المشروع بنجاح' , textAlign: TextAlign.center, style: TextStyle(fontSize: 30),)
              ],
            ),
          ),
...
class _SalesData {
  _SalesData(this.year, this.revenue);
